...
namespace AI.Demos.Three.Three
{
    public class Copycat : MonoBehaviour
    {
        ...
        void Start()
        {
            mVelocityMatch = new VelocityMatch(mKinematic, target.GetKinematic(), 10f);
        }

        // Update is called once per frame
        void Update()
        {
            mKinematic.Update(mVelocityMatch.GetSteering(), 10f, Time.deltaTime);
